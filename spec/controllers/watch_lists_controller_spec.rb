...
describe WatchListsController do
  ...
  describe "GET index" do
    it "assigns all watch_lists as @watch_lists" do
      ...
      assigns(:watch_lists).should eq([watch_list])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested watch_list as @watch_list" do
      ...
      assigns(:watch_list).should eq(watch_list)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new watch_list as @watch_list" do
      ...
      assigns(:watch_list).should be_a_new(WatchList)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created watch_list as @watch_list" do
        post :create, {:watch_list => valid_attributes}, valid_session
        assigns(:watch_list).should be_a(WatchList)
        assigns(:watch_list).should be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved watch_list as @watch_list" do
        ...
        post :create, {:watch_list => {}}, valid_session
        assigns(:watch_list).should be_a_new(WatchList)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested watch_list" do
        watch_list = WatchList.create! valid_attributes
        # Assuming there are no other watch_lists in the database, this
        ...
        put :update, {:id => watch_list.to_param, :watch_list => {'these' => 'params'}}, valid_session
      end
      ...
      it "redirects to the watch_list" do
        watch_list = WatchList.create! valid_attributes
        put :update, {:id => watch_list.to_param, :watch_list => valid_attributes}, valid_session
        response.should redirect_to(watch_list)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the watch_list as @watch_list" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        WatchList.any_instance.stub(:save).and_return(false)
        put :update, {:id => watch_list.to_param, :watch_list => {}}, valid_session
        assigns(:watch_list).should eq(watch_list)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the watch_lists list" do
      watch_list = WatchList.create! valid_attributes
      delete :destroy, {:id => watch_list.to_param}, valid_session
      response.should redirect_to(watch_lists_url)
    end
  end
